...
def attend():
    ...
    global name_list
    name_list = []
    a_image = face_recognition.load_image_file("rimon.jpg")
    a_face_encoding = face_recognition.face_encodings(a_image)[0]

    b_image = face_recognition.load_image_file("vinay.jpg")
    b_face_encoding = face_recognition.face_encodings(b_image)[0]

    c_image = face_recognition.load_image_file("shailesh.jpg")
    c_face_encoding = face_recognition.face_encodings(c_image)[0]
    
    d_image = face_recognition.load_image_file("rick.jpg")
